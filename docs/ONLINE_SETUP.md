...
2. Name: `conversastudio` (must match `SUPABASE_STORAGE_BUCKET`)
...
2. Connect [github.com/giannismparous/ConversaStudio](https://github.com/giannismparous/ConversaStudio)
...
| `PUBLIC_API_URL` | `https://conversastudio-api.onrender.com` |
...
1. Note your Netlify URL, e.g. `https://conversastudio.netlify.app`
...
| Service | Domain |
|---------|--------|
| Netlify | `app.conversastudio.com` |
| Render | `api.conversastudio.com` |
...
- [ ] Storage bucket `conversastudio` created (public)
...
| Upload fails | Bucket name `conversastudio`; service role key on API |
